...
const Scroll = (props) => {
    return (
        <ScrollView>
            ...
            <View style={{flexDirection:'row',height:70,width:'90%',borderColor:'#cccccc',borderWidth:1,borderRadius:10,marginHorizontal:20,marginVertical:20}}>
            ...
            <View style={{flexDirection:'row',height:140,width:'90%',backgroundColor:'#0f2638',borderRadius:10,marginHorizontal:20,marginVertical:20}}>
            <View style={{justifyContent:'center',marginBottom:50}}>
            <Text style={{color:'white',fontSize:15,marginLeft:120}}>As a free member,your profile</Text>
            <Text style={{color:'white',fontSize:15,marginLeft:120}} >is getting less views from</Text>
            <Text style={{color:'white',fontSize:15,marginLeft:150}} >potential matches</Text>
            </View>
            </View>
            <TouchableOpacity style={{position:'absolute',top:290,left:30,height:30,width:230,backgroundColor:'#eb9800',borderRadius:20,justifyContent:'center',marginLeft:75}}>
                <Text style={{alignSelf:'center',fontWeight:'bold',color:'white',fontSize:15}} >Upgrade to highlight your profile</Text>
            </TouchableOpacity>
